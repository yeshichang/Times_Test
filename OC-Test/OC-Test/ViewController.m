...
- (void)viewDidLoad {
    ...
    myTest1 = [[UILabel alloc] initWithFrame:CGRectMake(100, 100, 60, 40)];
...
//    ///移动的动画。
    ...
    //缩放效果。
    [myTest1.layer addAnimation:[self scale:[NSNumber numberWithFloat:1.0f] orgin:[NSNumber numberWithFloat:1.2f] durTimes:0.2f Rep:MAXFLOAT] forKey:nil];
//    //组合动画。
